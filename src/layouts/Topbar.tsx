...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-(--border) bg-white/92 px-4 py-2.5 backdrop-blur md:px-7 md:py-4">
        ...
        <div className="flex h-11 w-11 shrink-0 items-center justify-center">
          {shouldShowSettingsAction ? (
            <Link
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-(--border) bg-white text-(--text-muted) transition-colors duration-200 hover:border-(--accent-border) hover:text-(--accent)"
            >

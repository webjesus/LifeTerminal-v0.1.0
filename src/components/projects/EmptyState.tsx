...
export function EmptyState({ title, description, actionLabel, onAction }: EmptyStateProps) {
  return (
    <div className="rounded-3xl border border-dashed border-(--border) bg-(--panel) px-6 py-14 text-center shadow-(--shadow-soft)">
      <p className="text-xs uppercase tracking-[0.28em] text-(--text-muted)">Пространство проекта</p>

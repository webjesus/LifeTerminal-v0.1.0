      ...
      {dedupedSelectedItems.length > 0 ? (
        <div className="space-y-2">
          {dedupedSelectedItems.map((item) => (
            <div key={createItemKey(item)} className="flex max-w-full flex-col gap-3 rounded-2xl border border-(--border-soft) bg-(--panel) px-3.5 py-3 shadow-(--shadow-soft) sm:flex-row sm:items-center sm:justify-between">

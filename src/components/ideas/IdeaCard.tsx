  ...
  return (
    <article className="ui-panel ui-card-hover p-5 md:p-6">
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        ...
        <button type="button" onClick={() => onConvertToTask(idea)} className="rounded-2xl border border-[#d9e6ff] bg-[#eef5ff] px-3 py-2 text-sm font-medium text-[#4365c2] transition-all duration-200 active:scale-[0.98]">В задачу</button>

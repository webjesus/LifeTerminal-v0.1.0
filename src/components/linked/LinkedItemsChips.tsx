        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          ...
          {hiddenCount > 0 ? (
            <button
              ...
              className="inline-flex min-h-10 shrink-0 items-center rounded-full border border-(--border-soft) bg-(--panel-elevated) px-3 py-1.5 text-xs text-(--text-muted) transition-all duration-200 hover:border-(--accent-border) hover:text-(--text-primary)"
            >
              +{hiddenCount} ещё
            </button>
          ) : null}
